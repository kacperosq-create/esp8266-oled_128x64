...
float currentWeatherTempMax = 0.0;
float currentWeatherTempMin = 0.0;
...
const unsigned char epd_bitmap_thunderstorm[] PROGMEM = {
	0x00, 0x00, 0x00, 0x01, 0xe0, 0x00, 0x06, 0x18, 0x00, 0x08, 0x06, 0x00, 0x10, 0x01, 0x00, 0x20, 
	0x00, 0x80, 0x40, 0x00, 0x60, 0x40, 0x00, 0x20, 0x40, 0x78, 0x20, 0x20, 0x20, 0x20, 0x1e, 0x24, 
	0x10, 0x01, 0xfe, 0x00, 0x00, 0x40, 0x00, 0x00, 0x80, 0x00, 0x00, 0x70, 0x00, 0x00, 0x20, 0x00, 
...
const unsigned char epd_bitmap_sun[] PROGMEM = {
	0x00, 0x30, 0x00, 0x04, 0x30, 0x20, 0x02, 0x00, 0x40, 0x00, 0xff, 0x00, 0x01, 0x00, 0x80, 0x42, 0x00, 0x42, 
	0x24, 0x00, 0x24, 0x04, 0x00, 0x20, 0x14, 0x00, 0x28, 0x14, 0x00, 0x28, 0x14, 0x00, 0x28, 0xc9, 0x00, 0x93, 
	0xc9, 0x00, 0x93, 0x14, 0x00, 0x28, 0x14, 0x00, 0x28, 0x14, 0x00, 0x28, 0x04, 0x00, 0x20, 0x24, 0x00, 0x24, 0x42, 
	0x00, 0x42, 0x01, 0x00, 0x80, 0x00, 0xff, 0x00, 0x02, 0x00, 0x40, 0x04, 0x30, 0x20, 0x00, 0x30, 0x00
};

const unsigned char epd_bitmap_snowflake[] PROGMEM = {
	0x00, 0x30, 0x00, 0x00, 0x6b, 0x00, 0x01, 0x3c, 0x80, 0x00, 0x66, 0x00, 0x04, 0x6b, 0x20, 0x02, 0x3c, 0x40, 
	0x20, 0x3c, 0x04, 0x49, 0xff, 0x92, 0x33, 0x18, 0xcc, 0x4c, 0x3c, 0x32, 0x77, 0x7e, 0xee, 0xff, 0x1f, 0xff, 
	0xff, 0x1f, 0xff, 0x77, 0x7e, 0xee, 0x4c, 0x3c, 0x32, 0x33, 0x18, 0xcc, 0x49, 0xff, 0x92, 0x20, 0x3c, 0x04, 
	0x02, 0x3c, 0x40, 0x04, 0x6b, 0x20, 0x00, 0x66, 0x00, 0x01, 0x3c, 0x80, 0x00, 0x6b, 0x00, 0x00, 0x30, 0x00
};

const unsigned char epd_bitmap_rain[] PROGMEM = {
	0x00, 0x00, 0x00, 0x01, 0xe0, 0x00, 0x06, 0x18, 0x00, 0x08, 0x06, 0x00, 0x10, 0x01, 0x00, 0x20, 
	0x00, 0x80, 0x40, 0x00, 0x60, 0x40, 0x00, 0x20, 0x40, 0x00, 0x20, 0x20, 0x00, 0x20, 0x1e, 0x00, 
	0x10, 0x01, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x08, 0x88, 0x00, 0x11, 0x11, 0x00, 0x22, 0x22, 0x00, 
	0x11, 0x11, 0x00, 0x08, 0x88, 0x80, 0x04, 0x44, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const unsigned char epd_bitmap_partly_cloudy[] PROGMEM = {
	0x00, 0x03, 0x00, 0x00, 0x04, 0x80, 0x00, 0x20, 0x40, 0x00, 0x40, 0x20, 0x00, 0x40, 0x24, 0x00, 
	0x80, 0x18, 0x03, 0x00, 0x04, 0x04, 0x00, 0x04, 0x08, 0x00, 0x02, 0x10, 0x00, 0x02, 0x20, 0x00, 
	0x01, 0x40, 0x00, 0x01, 0x40, 0x00, 0x02, 0x40, 0x00, 0x02, 0x20, 0x00, 0x02, 0x1e, 0x00, 0x02, 0x01, 
	0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const unsigned char epd_bitmap_wind[] PROGMEM = {
	0x00, 0x01, 0xc0, 0x00, 0x02, 0x20, 0x00, 0x02, 0x20, 0x00, 0x01, 0xc0, 0x00, 0x00, 0x38, 0x00, 
	0x00, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00, 0x38, 0xff, 0xff, 0x80, 0x00, 0x00, 0x00, 0xa0, 0xff, 
	0x40, 0x00, 0x00, 0x40, 0x00, 0x00, 0x38, 0x00, 0xfe, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x10, 
	0x00, 0x00, 0x10, 0x00, 0x00, 0x20, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
const unsigned char epd_bitmap_snow[] PROGMEM = {
	0x00, 0x00, 0x00, 0x01, 0xe0, 0x00, 0x06, 0x18, 0x00, 0x08, 0x06, 0x00, 0x10, 0x01, 0x00, 0x20, 
	0x00, 0x80, 0x40, 0x00, 0x60, 0x40, 0x00, 0x20, 0x40, 0x00, 0x20, 0x20, 0x00, 0x20, 0x1e, 0x00, 
	0x10, 0x01, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x30, 0xc0, 0x0c, 0x30, 0xc0, 0x00, 0x00, 0x00, 
	0x33, 0x33, 0x00, 0x33, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
const unsigned char epd_bitmap_fog[] PROGMEM = {
	0x00, 0x00, 0x00, 0x01, 0xe0, 0x00, 0x06, 0x18, 0x00, 0x08, 0x06, 0x00, 0x10, 0x01, 0x00, 0x20, 
	0x00, 0x80, 0x40, 0x00, 0x60, 0x40, 0x00, 0x20, 0x40, 0x00, 0x20, 0x20, 0x00, 0x20, 0x1e, 0x00, 
	0x10, 0x01, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xcf, 0x80, 0x1f, 0xcf, 0x80, 0x00, 0x00, 0x00, 0x3f, 
	0xff, 0x00, 0x3f, 0xff, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xcf, 0x80, 0x1f, 0xcf, 0x80, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
void fetchWeatherFromInternet() {
  ...
  String url = "http://api.open-meteo.com/v1/forecast?latitude=" + String(lat, 4) +
               ...
               "&current=temperature_2m,relative_humidity_2m,weather_code&daily=temperature_2m_max,temperature_2m_min&timezone=auto";
  ...
  if (httpCode > 0) {
    ...
    if (!deserializeJson(doc, payload)) {
      ...
      currentWeatherTempMax = doc["daily"]["temperature_2m_max"][0]; 
      currentWeatherTempMin = doc["daily"]["temperature_2m_min"][0]; 
    }
  }
  http.end();
}
...
void drawWeatherScreen() {
  ...
  // --- 1. NAZWA MIASTA (Góra, wyśrodkowana) ---
  ...
  int cityX = (128 - (cName.length() * 6)) / 2;
  display.setCursor(cityX, 0);
  printPL(cName, 1);

  display.drawFastHLine(0, 10, 128, SSD1306_WHITE);

  // --- 2. DOPASOWANIE NOWYCH IKON 24x24 ---
  const unsigned char* weatherIcon = epd_bitmap_sun;

  if (currentWeatherCode == 0) { 
    weatherIcon = epd_bitmap_sun; 
  }
  else if (currentWeatherCode >= 1 && currentWeatherCode <= 3) { 
    weatherIcon = epd_bitmap_partly_cloudy; 
  }
  else if (currentWeatherCode >= 45 && currentWeatherCode <= 48) { 
    weatherIcon = epd_bitmap_fog; 
  }
  else if ((currentWeatherCode >= 51 && currentWeatherCode <= 67) || (currentWeatherCode >= 80 && currentWeatherCode <= 82)) { 
    weatherIcon = epd_bitmap_rain; 
  }
  else if (currentWeatherCode >= 71 && currentWeatherCode <= 77) { 
    weatherIcon = epd_bitmap_snow; 
  }
  else if (currentWeatherCode >= 95) { 
    weatherIcon = epd_bitmap_thunderstorm; 
  }

  // Rysowanie ikony 24x24 px (X=0, Y=13)
  display.drawBitmap(0, 13, weatherIcon, 24, 24, SSD1306_WHITE);

  // --- 3. DUŻA TEMPERATURA ---
  int intTemp = (int)round(currentWeatherTemp);
  display.setTextSize(2);
  display.setCursor(28, 16); // Odsuwamy tekst na X=28, żeby nie zasłaniał ikony 24px
  display.print(intTemp);

  // Symbol °C
  int tempWidth = (intTemp < 0 || intTemp >= 10 || intTemp <= -10) ? 24 : 12;
  display.setTextSize(1);
  display.setCursor(28 + tempWidth, 16);
  display.print("oC");
  ...
  // --- 5. MAX I MIN DZISIAJ ---
  int maxTemp = (int)round(currentWeatherTempMax);
  int minTemp = (int)round(currentWeatherTempMin);
  
  display.setCursor(0, 51);
  printPL("Max: " + String(maxTemp) + "oC  Min: " + String(minTemp) + "oC", 1);
